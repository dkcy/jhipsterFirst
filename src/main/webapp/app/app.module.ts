...
import { JhipsterFirstSharedModule } from 'app/shared';
import { JhipsterFirstCoreModule } from 'app/core';
import { JhipsterFirstAppRoutingModule } from './app-routing.module';
import { JhipsterFirstHomeModule } from './home/home.module';
import { JhipsterFirstAccountModule } from './account/account.module';
...
@NgModule({
    imports: [
        ...
        JhipsterFirstSharedModule.forRoot(),
        JhipsterFirstCoreModule,
        JhipsterFirstHomeModule,
        JhipsterFirstAccountModule,
